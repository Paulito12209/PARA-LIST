...
export const I18N = {
  de: {
    ...
    connectionsLabel: "Verknüpfungen",
    welcome: "Willkommen!",
    ...
    // Status-Kacheln im Options-Sheet einer Aufgabe/eines Termins
    statusInfoAria: "Was bedeuten die Status?",
    statusInfoDone: "Erledigt: Die Aufgabe ist abgeschlossen. Sie zählt zu deinem Fortschritt und verschwindet aus den offenen Listen.",
    statusInfoPostponed: "Verschoben: Du schaffst es heute nicht, willst die Aufgabe aber behalten. Sie bleibt offen – nach dem Antippen wählst du direkt das neue Datum.",
    statusInfoCancelled: "Abgesagt: Die Aufgabe ist hinfällig, ohne dass du sie erledigt hast. Sie wandert ins Archiv, bleibt dort nachvollziehbar und zählt nicht als erledigt.",
    customizeLabel: "Individualisieren",
    coverUrlPlaceholder: "Cover-Bild URL einfügen",
  ...
  en: {
    ...
    // Status tiles in the options sheet of a task/event
    statusInfoAria: "What do the statuses mean?",
    statusInfoDone: "Done: the task is complete. It counts towards your progress and leaves the open lists.",
    statusInfoPostponed: "Postponed: you won't get to it today but want to keep it. It stays open – tapping it lets you pick the new date right away.",
    statusInfoCancelled: "Cancelled: the task is off the table without being completed. It moves to the archive, stays traceable there and does not count as done.",
    customizeLabel: "Customize",
    coverUrlPlaceholder: "Paste cover image URL",
    applyLabel: "Apply",
  ...
  es: {
    ...
    // Casillas de estado en la hoja de opciones de una tarea/evento
    statusInfoAria: "¿Qué significan los estados?",
    statusInfoDone: "Hecho: la tarea está terminada. Cuenta para tu progreso y desaparece de las listas abiertas.",
    statusInfoPostponed: "Aplazada: hoy no llegas pero quieres conservarla. Sigue abierta: al pulsar eliges directamente la nueva fecha.",
    statusInfoCancelled: "Cancelada: la tarea ya no procede sin que la hayas completado. Pasa al archivo, queda registrada y no cuenta como hecha.",
    customizeLabel: "Personalizar",
    coverUrlPlaceholder: "Pegar URL de la imagen de portada",
    applyLabel: "Aplicar",
